...
class Packal
	...
	def self.submit( params )
		...
		RestClient::Request.execute(
			:url     => "http://localhost:3000/api/v1/alfred2/#{type}/submit",
			:payload => params,
			:method  => :post
		) # development
		...
		# Staging Server
		# RestClient::Request.execute(
		# 	:url     => "https://mellifluously.org/api/v1/alfred2/#{type}/submit",
		# 	:payload => params,
		# 	:method  => :post
		# )
		...
		# Production Server
		# RestClient::Request.execute(
		# 	:url     => "https://www.packal.org/api/v1/alfred2/#{type}/submit",
		# 	:payload => params,
		# 	:method  => :post
		# )
	end
